    ...
    pageEncoding="UTF-8"%>
   	...
   	<nav class="main-menu bg-danger">
		<ul class=" nav d-flex justify-content-around align-items-center list-unstyled text-white">
			...
			<li class="nav-item"><a href="/jspTemplete/test/test01/test01.jsp?category=영화" name="category" class="nav-link">영화</a></li>
			<li class="nav-item"><a href="/jspTemplete/test/test01/test01.jsp?category=스포츠" name="category" class="nav-link">스포츠</a></li>
		</ul>
